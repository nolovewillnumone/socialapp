...
async def chat(request: Request, db: Session = Depends(get_db)):
    try:
        ...
        if not api_key:
            # Fallback rule-based reply if no API key set
            q = messages[-1].get("content", "").lower() if messages else ""
            fallbacks = {
                "ru": "Привет! Я советник по талантам. Пройди тест и я помогу разобраться в твоих способностях! 🌟",
                "uz": "Salom! Men iste'dod bo'yicha maslahatchimanman. Testni topshiring va qobiliyatlaringizni bilib oling! 🌟",
                "en": "Hi! I'm your talent advisor. Take the quiz and I'll help you discover your abilities! 🌟",
            }
        ...
        fallbacks = {
            ...
            "uz": "Kechirasiz, xato yuz berdi. Qayta urinib ko'ring! 🙏",

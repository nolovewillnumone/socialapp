    ...
    try {
      ...
      if (status === 400) {
        ...
        if (Array.isArray(detail)) {
          ...
          const checkMsg = lang==="ru" ? "Проверь данные" : lang==="uz" ? "Tekshiring" : "Check your data";
          setError(msg || checkMsg);
        } else {
          const checkMsg2 = lang==="ru" ? "Проверь данные" : lang==="uz" ? "Tekshiring" : "Check your data";
          setError(checkMsg2);
        }
      } else if (status === 429) {
